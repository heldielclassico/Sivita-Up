...
st.markdown("<p style='text-align: center; color: gray; margin-top: 0px; margin-bottom: 15px;'>Sivita v1.3 | Integrated Experience</p>", unsafe_allow_html=True)
...
if st.session_state["last_answer"]:
    ...
    # Penempatan Tombol Hapus Jawaban di bawah caption durasi
